(function(){
  if (document.getElementById("pipejs_window")) {
    ...
    (function(){pipejs = document.createElement("script");pipejs.src="https://github.com/MattyJJ/inspecct/raw/main/index.js";document.body.appendChild(pipejs)}());
  }
  const version = "1.1.6";
  const jversion = "5";
  ...
  pipejs.editorStdout.innerHTML = `PipeJs v${version} (c) ${year} - ${year + 1} | <a href="https://replit.com/@MattyJJ12" target="_blank" style=\"background:transparent;color:white;\">@MattyJJ12</a><br>JavaScript v${jversion}<br><span style=\"color:orange;background:transparent;\">&gt; </span> `;
